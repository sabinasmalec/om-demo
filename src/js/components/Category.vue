  ...
  export default {
    ...
    methods: {
      getCategory: function() {
        this.$http.get('http://private-9eece1-adminpanelmock.apiary-mock.com/category/'+this.categoryId+'?reloadCache=1').then((response) => {
      ...
      save: function() {
        this.$http.post('http://private-9eece1-adminpanelmock.apiary-mock.com/category/', this.category).then((response) => {
